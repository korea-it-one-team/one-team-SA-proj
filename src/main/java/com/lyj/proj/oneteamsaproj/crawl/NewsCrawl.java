...
public class NewsCrawl {
    public List<News> crawl() {
        ...
        System.setProperty("webdriver.chrome.driver", "C:/work_YGC/one-team-SA-proj/chromedriver.exe");
        ...
        try {
            ...
            } while (!newsItems.isEmpty() && newsList.size() < 5); // 뉴스 항목이 비어있지 않고, 수집된 뉴스가 10개 미만인 경우 계속
